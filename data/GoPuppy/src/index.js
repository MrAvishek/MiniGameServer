...
// Add event listeners for touch/click to move the player
leftButton.addEventListener("mousedown", () => (pressedKeys.left = true));
rightButton.addEventListener("mousedown", () => (pressedKeys.right = true));

leftButton.addEventListener("mouseup", () => (pressedKeys.left = false));
rightButton.addEventListener("mouseup", () => (pressedKeys.right = false));

// Support for touch on mobile devices
leftButton.addEventListener("touchstart", () => (pressedKeys.left = true));
rightButton.addEventListener("touchstart", () => (pressedKeys.right = true));

leftButton.addEventListener("touchend", () => (pressedKeys.left = false));
rightButton.addEventListener("touchend", () => (pressedKeys.right = false));